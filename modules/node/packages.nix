  ...
  sources = {
    ...
    "@swc/core-1.11.24" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "MaQEIpfcEMzx3VWWopbofKJvaraqmL6HbLlw2bFZ7qYqYw3rkhM0cQVEgyzbHtTWwCwPMFZSC2DUbhlZgrMfLg==";
      };
    };
    "@swc/counter-0.1.3" = {
    ...
    "@swc/wasm-1.11.24" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "8Eo70Ns3BUboUaHfHhDfT/e0gA92+qpHggnb8oio+bfESMXBkmBdkQIln8TI27axKGc7uWz9M82kC8k9FJFq0w==";
      };
    };
    ...
    "@types/node-22.15.3" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "lX7HFZeHf4QG/J7tBZqrCAXwz9J5RD56Y6MpP0eJkka8p+K0RY/yBTW7CYFJ4VGCclxqOLKmiGP5juQc6MKgcw==";
      };
    };
    "acorn-8.14.1" = {
      name = "acorn";
...
in {
  ...
  sort-package-json = nodeEnv.buildNodePackage {
    ...
    src = fetchurl {
      url =
        "https://registry.npmjs.org/sort-package-json/-/sort-package-json-3.2.0.tgz";
      sha512 =
        "jadbj4vvIlevL578X5+1qVX/Nn9Jk7/U+cLVjR1IqfDFo3ISY0eoyksd3ylyTwGunlEMUgbTRYowLr0CkSxcQw==";
    };
    dependencies = [

  ...
  sources = {
    ...
    "@swc/core-1.10.18" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "IUWKD6uQYGRy8w2X9EZrtYg1O3SCijlHbCXzMaHQYc1X7yjijQh4H3IVL9ssZZyVp2ZDfQZu4bD5DWxxvpyjvg==";
      };
    };
    "@swc/counter-0.1.3" = {
    ...
    "@swc/types-0.1.18" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "NZghLaQvF3eFdj2DUjGkpwaunbZYaRcxciHINnwA4n3FrLAI8hKFOBqs2wkcOiLQfWkIdfuG6gBkNFrkPNji5g==";
      };
    };
    "@swc/wasm-1.10.18" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "TgoMYjQ2/9UfUaw7WuKj7Svew6kaNOqkjV4nKoc2tf34e+7GxL2KPoXvM2b1RkPxNocv85glcQpS9KMk8FqpBA==";
      };
    };
    ...
    "@types/node-22.13.5" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "+lTU0PxZXn0Dr1NBtC7Y8cR21AJr87dLLU953CWA6pMxxv/UDc7jYAY90upcrie1nRcD6XNG5HOYEDtgW5TxAg==";
      };
    };
    "acorn-8.14.0" = {
      name = "acorn";
    ...
    "call-bound-1.0.3" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "YTd+6wGlNlPxSuri7Y6X8tY2dmm12UMH66RpKMhiX6rsk5wXXnYgbUcOt8kiS31/AjfoTOvCsE+w8nZQLQnzHA==";
      };
    };
    "chalk-4.1.2" = {
      name = "chalk";
    ...
    "typescript-5.7.3" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "84MVSjMEHP+FQRPy3pX9sTVV/INIex71s9TL2Gm5FG/WG1SqXeKyZ0k7/blY/4FdOzI12CBy1vGc4og/eus0fw==";
      };
    };
    "undici-types-6.20.0" = {
      name = "undici-types";
...
in {
  ...
  sort-package-json = nodeEnv.buildNodePackage {
    ...
    src = fetchurl {
      url =
        "https://registry.npmjs.org/sort-package-json/-/sort-package-json-2.14.0.tgz";
      sha512 =
        "xBRdmMjFB/KW3l51mP31dhlaiFmqkHLfWTfZAno8prb/wbDxwBPWFpxB16GZbiPbYr3wL41H8Kx22QIDWRe8WQ==";
    };
    dependencies = [

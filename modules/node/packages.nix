...
in
{
  ...
  sort-package-json = nodeEnv.buildNodePackage {
    ...
    version = "3.5.0";
    src = fetchurl {
      url = "https://registry.npmjs.org/sort-package-json/-/sort-package-json-3.5.0.tgz";
      sha512 = "moY4UtptUuP5sPuu9H9dp8xHNel7eP5/Kz/7+90jTvC0IOiPH2LigtRM/aSFSxreaWoToHUVUpEV4a2tAs2oKQ==";
    };
    dependencies = [

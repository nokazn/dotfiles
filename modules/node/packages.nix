...
let
  sources = {
    ...
    "@swc/core-1.8.0" = {
      ...
      version = "1.8.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@swc/core/-/core-1.8.0.tgz";
        sha512 = "EF8C5lp1RKMp3426tAKwQyVbg4Zcn/2FDax3cz8EcOXYQJM/ctB687IvBm9Ciej1wMcQ/dMRg+OB4Xl8BGLBoA==";
      };
    };
    "@swc/counter-0.1.3" = {
    ...
    "@swc/wasm-1.8.0" = {
      ...
      version = "1.8.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@swc/wasm/-/wasm-1.8.0.tgz";
        sha512 = "uaVt1O0VAALP0njZ654addUWjVaOHjsU0yXNpYKvy0cczg7YAeXGWMSQtrllyrBaS9WtiVPra9J3q08jiu1Ujg==";
      };
    };
    ...
    "@types/node-22.8.7" = {
      ...
      version = "22.8.7";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/node/-/node-22.8.7.tgz";
        sha512 = "LidcG+2UeYIWcMuMUpBKOnryBWG/rnmOHQR5apjn8myTQcx3rinFRn7DcIFhMnS0PPFSC6OafdIKEad0lj6U0Q==";
      };
    };
    "acorn-8.14.0" = {
      name = "acorn";

...
let
  sources = {
    ...
    "@types/node-16.18.75" = {
      ...
      version = "16.18.75";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/node/-/node-16.18.75.tgz";
    ...
    "@types/node-18.19.9" = {
      ...
      version = "18.19.9";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/node/-/node-18.19.9.tgz";
        sha512 = "oZFKlC8l5YtzGQNT4zC2PiSSKzQVZ8bAwwd+EYdPLtyk0nSEq6O16SkK+rkkT2eflDAbormJgEF3QnH3oDrTSw==";
      };
    };
    "@types/node-20.11.6" = {
      name = "_at_types_slash_node";

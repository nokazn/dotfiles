...
let
  sources = {
    ...
    "@swc/wasm-1.5.8" = {
      ...
      version = "1.5.8";
      src = fetchurl {
        url = "https://registry.npmjs.org/@swc/wasm/-/wasm-1.5.8.tgz";
        sha512 = "f7eTsgZF9Ej/clRQ6jPtNphwwWonEVqGC4x88h71vS62Gels6Ct7FkqCLGP9jbiTqy9dQdjfeeGuI7mQU5RS+w==";
      };
    };

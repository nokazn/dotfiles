  ...
  sources = {
    ...
    "@swc/core-1.11.7" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "ICuzjyfz8Hh3U16Mb21uCRJeJd/lUgV999GjgvPhJSISM1L8GDSB5/AMNcwuGs7gFywTKI4vAeeXWyCETUXHAg==";
      };
    };
    "@swc/counter-0.1.3" = {
    ...
    "@swc/wasm-1.11.7" = {
      ...
      src = fetchurl {
        ...
        sha512 =
          "OS11ClTQFldQJRX1RRsT3B3MQVplAdMthXH6ha7WCNAsoP3Rtzq/MUJ7LpkBIUV9Ty8Xk5lPzfeRNscFQ6sFEw==";
      };
    };
    ...
    "portfinder-1.0.33" = {
      ...
      version = "1.0.33";
      src = fetchurl {
        url = "https://registry.npmjs.org/portfinder/-/portfinder-1.0.33.tgz";
        sha512 =
          "+2jndHT63cL5MdQOwDm9OT2dIe11zVpjV+0GGRXdtO1wpPxv260NfVqoEXtYAi/shanmm3W4+yLduIe55ektTw==";
      };
    };
    "qs-6.14.0" = {
      name = "qs";

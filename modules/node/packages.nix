...
in {
  ...
  sort-package-json = nodeEnv.buildNodePackage {
    ...
    src = fetchurl {
      url =
        "https://registry.npmjs.org/sort-package-json/-/sort-package-json-3.4.0.tgz";
      sha512 =
        "97oFRRMM2/Js4oEA9LJhjyMlde+2ewpZQf53pgue27UkbEXfHJnDzHlUxQ/DWUkzqmp7DFwJp8D+wi/TYeQhpA==";
    };
    dependencies = [

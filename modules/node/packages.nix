...
let
  sources = {
    ...
    "@swc/wasm-1.15.8" = {
      ...
      version = "1.15.8";
      src = fetchurl {
        url = "https://registry.npmjs.org/@swc/wasm/-/wasm-1.15.8.tgz";
        sha512 = "RG2BxGbbsjtddFCo1ghKH6A/BMXbY1eMBfpysV0lJMCpI4DZOjW1BNBnxvBt7YsYmlJtmy5UXIg9/4ekBTFFaQ==";
      };
    };
    ...
    "sort-object-keys-2.0.1" = {
      ...
      version = "2.0.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/sort-object-keys/-/sort-object-keys-2.0.1.tgz";
        sha512 = "R89fO+z3x7hiKPXX5P0qim+ge6Y60AjtlW+QQpRozrrNcR1lw9Pkpm5MLB56HoNvdcLHL4wbpq16OcvGpEDJIg==";
      };
    };
...
in
{
  ...
  sort-package-json = nodeEnv.buildNodePackage {
    ...
    version = "3.6.0";
    src = fetchurl {
      url = "https://registry.npmjs.org/sort-package-json/-/sort-package-json-3.6.0.tgz";
      sha512 = "fyJsPLhWvY7u2KsKPZn1PixbXp+1m7V8NWqU8CvgFRbMEX41Ffw1kD8n0CfJiGoaSfoAvbrqRRl/DcHO8omQOQ==";
    };
    dependencies = [
      ...
      sources."sort-object-keys-2.0.1"

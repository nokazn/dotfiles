...
let
  sources = {
    ...
    "@swc/wasm-1.10.9" = {
      ...
      version = "1.10.9";
      src = fetchurl {
        url = "https://registry.npmjs.org/@swc/wasm/-/wasm-1.10.9.tgz";
        sha512 = "KjsYO284jxkblhfyAvH43ptL9SUDc6zikYy4q8COo6vhK+I1zZSgIQtrXWaTN284ar1emlhlYKgZoOcE4UIWIQ==";
      };
    };

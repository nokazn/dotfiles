...
let
  sources = {
    ...
    "@swc/core-1.7.18" = {
      ...
      version = "1.7.18";
      src = fetchurl {
        url = "https://registry.npmjs.org/@swc/core/-/core-1.7.18.tgz";
    ...
    "@swc/wasm-1.7.18" = {
      ...
      version = "1.7.18";
      src = fetchurl {
        url = "https://registry.npmjs.org/@swc/wasm/-/wasm-1.7.18.tgz";
        sha512 = "5yABfGY05l87e32xMC0UNLOuvlnraQLnIiNE7b9fajD37yCA1UO9ch3See4mEt0ZpLp07c+GPHFtZ7nCBpG6JA==";
      };
    };

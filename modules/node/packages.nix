...
let
  sources = {
    ...
    "@swc/core-1.15.0" = {
      ...
      version = "1.15.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@swc/core/-/core-1.15.0.tgz";
        sha512 = "8SnJV+JV0rYbfSiEiUvYOmf62E7QwsEG+aZueqSlKoxFt0pw333+bgZSQXGUV6etXU88nxur0afVMaINujBMSw==";
      };
    };
    "@swc/counter-0.1.3" = {
    ...
    "@swc/wasm-1.15.0" = {
      ...
      version = "1.15.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@swc/wasm/-/wasm-1.15.0.tgz";
        sha512 = "bIxXPOFQXlYKXPhiaYWpY/83qXgTDSLaaB+0AtSh7UtW7ZZttr3Vp0/mzOB8ovCAurC8Eac3Ppn8oj6/IYnjGA==";
      };
    };

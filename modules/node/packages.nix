...
let
  sources = {
    ...
    "@swc/wasm-1.9.3" = {
      ...
      version = "1.9.3";
      src = fetchurl {
        url = "https://registry.npmjs.org/@swc/wasm/-/wasm-1.9.3.tgz";
        sha512 = "xVrK28qNm6g4m+kr8oZsd5gswHViwECFTjCKaCR7vDMiTgsrZfsaBPC070tUKQstQGXSZMs1c5t9xnWLgWy6ig==";
      };
    };

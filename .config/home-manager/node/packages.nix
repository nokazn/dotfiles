...
let
  sources = {
    ...
    "@types/vinyl-2.0.9" = {
      ...
      version = "2.0.9";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/vinyl/-/vinyl-2.0.9.tgz";
        sha512 = "KCr4aTEUkzSF89qw09e2oxsC/RXXT3K5ZPv4gvj3XTiWVrxNoi7WrqNTahNE/Hul5C9z3B8w+yWNTQgua12oag==";
      };
    };
    "abbrev-1.1.1" = {
      name = "abbrev";
